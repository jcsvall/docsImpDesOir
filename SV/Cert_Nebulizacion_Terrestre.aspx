<%@ Page Language="C#" MasterPageFile="~/Sitc_SV.master" AutoEventWireup="true" CodeFile="Cert_Nebulizacion_Terrestre.aspx.cs" Inherits="Cert_Nebulizacion_Terrestre" Title="OIRSA - SITC" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="SampleContent" Runat="Server">
    ...
    <script src="<%= Page.ResolveUrl("~/JS/Core/Nebulizacion.SV.js") + "?id=" + DateTime.Now.ToString() %>"></script>
    <script src="<%= Page.ResolveUrl("~/JS/Core/Nebulizacion.SV.CIEX.js") %>"></script>
        ...
        <table width="100%" border="0">
            <tr>
                <td colspan="2">
                    <table width="100%" border="0">
                        <tr>
                            <td valign="top" align="left"><div id="dvTitle" class="demoheading">NEBULIZACIÓN TERRESTRE</div></td>
                            <td align="right">
        ...
        <table width="95%">
            <tr>
                ...
                <td>
                    ...
                    <asp:CheckBox ID="cb_combo" runat="server" Enabled="False" AutoPostBack="False" Text="COMBO (ASP/ATOM)" Font-Bold="true" OnCheckedChanged="cb_combo_CheckedChanged" />
                </td>
            </tr>
            <tr>
                <td>Cantidad</td>
            ...
            <tr>
             ...
             <tr>
                ...
                <td>
                    <asp:TextBox runat="server" ID="tb_cantidad_cubicada" Text="0" Width="70px" AutoPostBack="False"  />
