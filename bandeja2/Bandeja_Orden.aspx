<%@ Page Language="C#" MasterPageFile="~/Sitc_Sv.master" AutoEventWireup="true" CodeFile="Bandeja_Orden.aspx.cs"
    Inherits="Bandeja_Orden" Title="OIRSA - SITC" %>
...
<div id="contenidoPagina" style="display:none">
   ...
   <div id="pagingGrid"></div>
    ...
    <script src="../JS/Core/BandejaOrdenes2SV.js" type="text/javascript"></script>
